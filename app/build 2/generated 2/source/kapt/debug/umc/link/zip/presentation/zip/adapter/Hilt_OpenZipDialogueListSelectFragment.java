...
public abstract class Hilt_OpenZipDialogueListSelectFragment<V extends ViewDataBinding> extends BaseBottomSheetDialogFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_OpenZipDialogueListSelectFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OpenZipDialogueListSelectFragment_GeneratedInjector) this.generatedComponent()).injectOpenZipDialogueListSelectFragment(UnsafeCasts.<OpenZipDialogueListSelectFragment>unsafeCast(this));
    }
  }
