...
public abstract class Hilt_ProfilesetFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProfilesetFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProfilesetFragment_GeneratedInjector) this.generatedComponent()).injectProfilesetFragment(UnsafeCasts.<ProfilesetFragment>unsafeCast(this));
    }
  }
