...
public abstract class Hilt_OpenZipDialogueLineupFragment<V extends ViewDataBinding> extends BaseBottomSheetDialogFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_OpenZipDialogueLineupFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OpenZipDialogueLineupFragment_GeneratedInjector) this.generatedComponent()).injectOpenZipDialogueLineupFragment(UnsafeCasts.<OpenZipDialogueLineupFragment>unsafeCast(this));
    }
  }
