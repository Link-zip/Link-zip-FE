...
public abstract class Hilt_ZipDialogueLineupFragment<V extends ViewDataBinding> extends BaseBottomSheetDialogFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ZipDialogueLineupFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ZipDialogueLineupFragment_GeneratedInjector) this.generatedComponent()).injectZipDialogueLineupFragment(UnsafeCasts.<ZipDialogueLineupFragment>unsafeCast(this));
    }
  }
