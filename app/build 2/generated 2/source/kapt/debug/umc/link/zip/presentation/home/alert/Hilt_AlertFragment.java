...
public abstract class Hilt_AlertFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_AlertFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlertFragment_GeneratedInjector) this.generatedComponent()).injectAlertFragment(UnsafeCasts.<AlertFragment>unsafeCast(this));
    }
  }
