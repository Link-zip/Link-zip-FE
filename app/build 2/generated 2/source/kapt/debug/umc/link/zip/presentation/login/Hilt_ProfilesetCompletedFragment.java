...
public abstract class Hilt_ProfilesetCompletedFragment<V extends ViewDataBinding> extends BaseFragment<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProfilesetCompletedFragment(int layoutResource) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProfilesetCompletedFragment_GeneratedInjector) this.generatedComponent()).injectProfilesetCompletedFragment(UnsafeCasts.<ProfilesetCompletedFragment>unsafeCast(this));
    }
  }
